...
import { factUrls } from './facts';
import { verifyLinks, hasUnsourcedLink } from './link-source';
import { PLACEHOLDER } from './post-assembler';
 ...
 */
export function evaluateGrounding(draft: ContentDraft, facts?: FactsBlock): GroundingVerdict {
