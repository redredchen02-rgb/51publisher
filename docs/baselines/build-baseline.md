...
| `@51publisher/backend` | `pnpm --filter "@51publisher/backend" build` | **3.58s** |
| `@51publisher/extension` | `pnpm build:extension` | **2.30s** |
...
| `@51publisher/backend` | 3.58s | < 15s | > 30s |
| `@51publisher/extension` | 2.30s | < 30s | > 60s |
