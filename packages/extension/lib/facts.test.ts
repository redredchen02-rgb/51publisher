...
import { parseTopicLine, isEmptyFacts, factUrls, formatFactsForPrompt, applyPromptTemplate } from '@51publisher/shared';
...
describe('factUrls', () => {
  it('collects urls from 漢化/無修/简介', () => {
    expect(factUrls({ 漢化: 'http://a/1', 無修: 'https://b/2', 简介: '见 https://c/3 这里', 作品名: 'X' })).toEqual([
      'http://a/1',
      'https://b/2',
      'https://c/3',
    ]);
