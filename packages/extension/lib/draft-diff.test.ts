...
function draft(overrides: Partial<ContentDraft> = {}): ContentDraft {
  return {
    id: 'id1', title: 'T', subtitle: 'S', category: '2', coverImageUrl: '',
    body: '<p>body</p>', tags: ['a', 'b'], description: 'desc',
    postStatus: '0', publishedAt: '2026-01-01', mediaId: 'm1',
    status: 'filled', createdAt: '2026-01-01T00:00:00Z',
    ...overrides,
  };
}
...
describe('computeSlotDiff', () => {
  ...
  it('id/status/createdAt 不参与比较', () => {
    const ai = draft({ id: 'id1', status: 'filled', createdAt: '2026-01-01T00:00:00Z' });
    const final = draft({ id: 'id2', status: 'published', createdAt: '2026-06-01T00:00:00Z' });
    const r = computeSlotDiff(ai, final);
