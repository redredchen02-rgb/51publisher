...
const ENDPOINT = process.env.LLM_ENDPOINT || process.env.BASE_URL || 'https://la-sealion.inaiai.com/v1';
...
const CASES: { topic: string; facts: Record<string, string> }[] = [
  ...
  {
    topic: '某成人同人漫畫推薦',
    facts: { 作品名: '测试同人乙', 题材: '同人本', 简介: '人气角色二创', 漢化: 'https://example.com/manga' },
  },
