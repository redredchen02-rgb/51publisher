...
import type { SafetyMode, ContentDraft } from '@51publisher/shared';
  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', padding: 12, fontSize: 14 }}>
      ...
      {quarantineAlert > 0 && (
        ...
        >
          <div style={{ color: '#874d00', fontWeight: 600 }}>⚠ {quarantineAlert} 条帖子在上次关机时状态不确定</div>
          <div style={{ color: '#874d00', fontSize: 12, marginTop: 2 }}>请前往「历史」面板核对后再继续。</div>
          <button
            onClick={() => {
      ...
      {showStarter && (
        <div style={{ marginTop: 12 }}>
          ...
          <button
            ...
            disabled={busy}
            style={{ ...btn, background: '#1677ff', color: '#fff', marginTop: 8 }}
          >
            {busy ? '生成中…' : '开始批量(生成+填充)'}
          </button>
        </div>
